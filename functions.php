...
function university_files(){
    // whatever name, path, dependencies, version, load before closing body tag
    ...
    //if current url matches fictional-university.local
...
// moment it runs, function name to execute
add_action('wp_enqueue_scripts','university_files');

function university_features(){
    //menu id, menu actual name
